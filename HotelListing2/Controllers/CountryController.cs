...
namespace HotelListing2.Controllers
{
    ...
    public class CountryController : ControllerBase
    {
        ...
        [HttpGet]
        //we remove cache header because we have that part in ServiceExtensions
        //[ResponseCache(CacheProfileName = "120SecondsDuration")]   //[ResponseCache(Duration = 60)]   // 60 seconds
        ...
        public async Task<IActionResult> GetCountry(int id)
        {
            ...
            //try
            //{
            //throw new Exception();  //force an exception for testing purposes
